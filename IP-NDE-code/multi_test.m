...
adv_n=double(adv_n)*255.0;
 [RI CI] = size(Io);
% alpha=1.2;q=1.6;dt=0.24;iter=557; sigma=1,lamba=0,k=1;%div2, texture2
alpha=1.1;q=1.0;dt=0.2;iter=600; sigma=0.2,lamba=0,k=0.2;%div2, texture2
...
%%  
tic;
[SSIMAll, IM_MAE,PSNRAll,J]=multi_1(Io,adv_n,Id,iter,dt,sigma,alpha,q,lamba,k);
%[IM_MAE,PSNRAll,J]=regular_PM(Io,In,dt,iter,sigma);
toc;
image_M1=sprintf('result/synthetic_L4_DE_TV.png');
