...
%下面是IP-NDE的参数%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% alpha=1.1;q=1.0;dt=0.2;iter=32; sigma=0.4,lamba=0,k=0.2;%div2, texture2 % L4 19.5771  0.7447
%  alpha=1.2;q=1.0;dt=0.2;iter=60; sigma=0.7,lamba=0,k=0.2;%div2, texture2 %L1 16.7457   0.5232
%  alpha=1.4;q=1.1;dt=0.2;iter=60; sigma=0.5,lamba=0,k=0.3;%div2, texture2 %L10  21.7313  0.8468

%  alpha=1.4;q=1.0;dt=0.2;iter=108; sigma=0.7,lamba=0,k=0.3;%div2, aerial_L1   24.9086 0.6322
%  alpha=1.1;q=1.2;dt=0.2;iter=75; sigma=0.2,lamba=0,k=0.3;%div2, aerial_L4   27.4745 0.7856
%alpha=1.4;q=1.3;dt=0.2;iter=114; sigma=0.2,lamba=0,k=0.3;%div2, aerial_L10   29.3763  0.8585

%  alpha=1.3;q=1.4;dt=0.2;iter=550; sigma=0.9,lamba=0,k=0.7;%div2, Lena_L1  24.5638   0.7979 
%  alpha=1.0;q=1.5;dt=0.2;iter=143; sigma=0.5,lamba=0,k=0.3;%div2, Lena_L4  26.6396   0.8676
%  alpha=1.2;q=1.4;dt=0.2;iter=108; sigma=0.5,lamba=0,k=0.3;%div2, Lena_L10    28.3831 0.9015
...
alpha=1.1;q=1.0;dt=0.2;iter=100; sigma1=0.1,sigma2=0.4,lamba=0.01,k=0.2;%div2, texture2 % L4 19.5771  0.7447%div2, aerial_L1   24.9086 0.6322
%%  
tic;
[SSIMAll, IM_MAE,PSNRAll,J]=multi_3(Io,adv_n,Id,iter,dt,sigma1,sigma2,alpha,q,lamba,k);
